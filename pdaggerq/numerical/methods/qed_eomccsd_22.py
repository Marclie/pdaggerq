...
class QED_EOMCCSD_22:
    ...
    def right_solver(self):
        ...
        right_sigma0_2p_func = eomcc_sigma('sigma0_2p',
            T,
            [['B-', 'B-']],
            R,
            'right_sigma0_2p',
        ...
        right_sigma1_2p_func = eomcc_sigma('sigma1_2p',
            T,
            [['B-', 'B-', 'e1(i,a)']],
            R,
            'right_sigma1_2p',
        ...
        right_sigma2_2p_func = eomcc_sigma('sigma2_2p',
            T,
            [['B-', 'B-', 'e2(i,j,b,a)']],
            R,
            'right_sigma2_2p',
        ...
        exec(right_sigma0_2p_func, globals(), local_namespace)
        ...
        # call solver
        self.eomcc_solver.right_solver(
            R_list=[r0, r1, r2, r0_1p, r1_1p, r2_1p, r0_2p, r1_2p, r2_2p]
        )
    ...
    def left_solver(self):
        ...
        left_sigma0_2p_func = eomcc_sigma('sigma0_2p',
            T,
            L,
            [['B+', 'B+']],
            'left_sigma0_2p',
        ...
        left_sigma1_2p_func = eomcc_sigma('sigma1_2p',
            T,
            L,
            [['B+', 'B+', 'e1(a,i)']],
            'left_sigma1_2p',
        ...
        left_sigma2_2p_func = eomcc_sigma('sigma2_2p',
            T,
            L,
            [['B+', 'B+', 'e2(a,b,j,i)']],
            'left_sigma2_2p',
        ...
        exec(left_sigma0_2p_func, globals(), local_namespace)
        ...
        # call solver
        self.eomcc_solver.left_solver(
            L_list=[l0, l1, l2, l0_1p, l1_1p, l2_1p, l0_2p, l1_2p, l2_2p]
        )
    ...
    def oscillator_strengths(self):
        ...
        f = self.eomcc_solver.oscillator_strengths(
    ...
    def opdm(self):
        ...
        opdm_a, opdm_b = self.eomcc_solver.opdm(
            opdm_func=local_namespace['density_matrix']
        )
    ...
    def tpdm(self):
        ...
        tpdm_aaaa, tpdm_abab, tpdm_bbbb = self.eomcc_solver.tpdm(
            tpdm_func=local_namespace['density_matrix']
        )
    ...
    def phdm(self):
        ...
        # Import pq eomcc photon density matrix codegen function
        from pdaggerq.numerical.codegen.autogen import eomcc_phdm

        # Generate photon density matrix equations
        T = ['t1', 't2', 'tb1', 'teb11', 'teb21', 'tb2', 'teb12', 'teb22']
        R = [['r0'], ['r1'], ['r2'], ['rb1'], ['reb11'], ['reb21'],
             ['rb2'], ['reb12'], ['reb22']]
        L = [['l0'], ['l1'], ['l2'], ['lb1'], ['leb11'], ['leb21'],
        ...
        phdm = self.eomcc_solver.phdm(
            phdm_func=local_namespace['density_matrix']
        )
